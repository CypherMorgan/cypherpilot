...
from app.modules.failure_analysis.exporters import get_exporter
...
class FailureAnalysisService:
    ...
    async def analyze(
        ...
        await log_audit(
            ...
            metadata={"module": "failure_analysis", "title": session.title},
        )
    ...
    async def export_session(
        ...
        return ExportFile(
            ...
            filename=export_filename("failure-analysis", session_id, format_name),
        )
    ...
    async def delete_session(self, session_id: UUID) -> None:
        ...
        await log_audit(
            ...
            metadata={"module": "failure_analysis"},
        )
